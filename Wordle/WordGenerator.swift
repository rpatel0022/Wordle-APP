...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE", "APPLE", "BEETS", "BEACH", "CLOUD", "DANCE", "EAGLE", "FROST", "FROST", "GLIDE", "HAPPY", "JOLLY", "KOALA"]
    
  static func generateRandomWord() -> String? {
      //START CODE HERE
      guard let randomWord = possibleWords.randomElement() else {
          return nil // Return nil if the list of possible words is empty
